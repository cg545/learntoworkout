    ...
    <center>
      <form class="login" action="<?php echo htmlspecialchars($action) ?>" method="post" novalidate>
        ...
        <div class="label-input">
          <label for="username" class="sr-only">Please enter your username in the box below.</label>
          <input class="form-control" placeholder="Username" id="username" type="text" name="login_username" value="<?php echo htmlspecialchars($sticky_login_username); ?>" required autofocus />
        </div>
        <br>
        <div class="label-input">
          <label for="password" class="sr-only">Please enter your password in the box below.</label>
          <input id="password" type="password" name="login_password" class="form-control" placeholder="Password" required />
        </div>
